    ...
    tonic_build::configure()
        ...
        .compile(
            &[
                ...
                "Xray-core/app/geodata/config.proto",
                ...
                "Xray-core/proxy/hysteria/account/config.proto",
                ...
                "Xray-core/transport/internet/finalmask/fragment/config.proto",
                "Xray-core/transport/internet/finalmask/salamander/config.proto",
                "Xray-core/transport/internet/finalmask/header/custom/config.proto",
                "Xray-core/transport/internet/finalmask/mkcp/aes128gcm/config.proto",
                "Xray-core/transport/internet/finalmask/mkcp/header/config.proto",
                "Xray-core/transport/internet/finalmask/mkcp/original/config.proto",
                "Xray-core/transport/internet/finalmask/noise/config.proto",
                "Xray-core/transport/internet/finalmask/realm/config.proto",
