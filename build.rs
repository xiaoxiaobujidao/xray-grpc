    ...
    tonic_build::configure()
        ...
        .compile(
            &[
                ...
                "Xray-core/transport/internet/finalmask/header/dns/config.proto",
                "Xray-core/transport/internet/finalmask/header/dtls/config.proto",
                "Xray-core/transport/internet/finalmask/header/srtp/config.proto",
                "Xray-core/transport/internet/finalmask/header/utp/config.proto",
                "Xray-core/transport/internet/finalmask/header/wechat/config.proto",
                "Xray-core/transport/internet/finalmask/header/wireguard/config.proto",
                "Xray-core/transport/internet/finalmask/mkcp/aes128gcm/config.proto",
                "Xray-core/transport/internet/finalmask/mkcp/original/config.proto",
